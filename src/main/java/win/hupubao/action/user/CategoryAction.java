...
public class CategoryAction extends BaseAction {
    ...
    public String categorys(HttpServletRequest request,
        ...
        PageBean<Category> pageBean = getPageBean(requestBean);
        try {
            Category category = getEntity(requestBean, Category.class);
            pageBean = categoryService.selectCategoryList(category, pageBean);
            pageBean.success();
        } catch (Exception e) {
            pageBean.error(e);
        }
